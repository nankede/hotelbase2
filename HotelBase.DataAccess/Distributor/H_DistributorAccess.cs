...
namespace HotelBase.DataAccess.Distributor
{
    public class H_DistributorAccess 
    {
        ...
        public static int AddModel(H_DistributorInfoModel model)
        {
            ...
            para.Add("@DSignTypeName", model.DSignTypeName ?? string.Empty);
            ...
            para.Add("@DCommissionPoint", model.DCommissionPoint ?? string.Empty);
            para.Add("@DInvoiceTitle", model.DInvoiceTitle ?? string.Empty);
            para.Add("@DTaxNumbe", model.DTaxNumbe ?? string.Empty);
            para.Add("@DInvoiceProject", model.DInvoiceProject ?? string.Empty);
            para.Add("@DBillType", model.DBillType ?? string.Empty);
            para.Add("@DLinkMan", model.DLinkMan);
            para.Add("@DLinkMobile", model.DLinkMobile);
            para.Add("@DLinkEmail", model.DLinkEmail ?? string.Empty);
            para.Add("@DLineAddress", model.DLineAddress ?? string.Empty);
            para.Add("@DLineChannel", model.DLineChannel ?? string.Empty);
            para.Add("@DRemark", model.DRemark ?? string.Empty);
            para.Add("@DIsValid", 1);
            para.Add("@DAddName", model.DAddName ?? string.Empty);
            para.Add("@DUpdateName", model.DUpdateName ?? string.Empty);
