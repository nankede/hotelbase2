...
namespace HotelBase.Web
{
    public class AutoFacConfig
    {
        ...
        public static void RegisterServices()
        {
            ...
            Assembly serviceAss = Assembly.Load("HotelBase.Service");
            ...
            Assembly repositoryAss = Assembly.Load("HotelBase.DataAccess");
            Type[] repositoryTypes = repositoryAss.GetTypes();
            builder.RegisterTypes(repositoryTypes).Where(t => t.Name.EndsWith("DataAccess")).AsImplementedInterfaces();
